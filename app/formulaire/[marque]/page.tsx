...
function Page({ params }: { params: { marque: string } }) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      // numero: Yup.string().required("Le  champs numéro de commande est requis"),
      //poids: Yup.string().required("Le  champs poids est requis"),
      montant: Yup.string().required("Le  champs montant total est requis"),
      //description: Yup.string().required("Le  champs nom est requis"),
