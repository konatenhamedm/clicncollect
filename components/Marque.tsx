    ...
    <>
      <div className="font-[sans-serif] bg-[#F5F5F5]">
        <div className="py-4 px-2 mx-auto w-full">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 max-xl:gap-4 gap-6">
            <CardMarque
              image="/images/marque/1.png"
              nom="adidas"
              lien="https://www.adidas.fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="lacoste"
              lien="https://www.lacoste.com/fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="channel"
              lien="https://www.histoiredor.com/fr_FR"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="ho"
            ...
            <CardMarque
              image="/images/marque/1.png"
              nom="ca"
              lien="https://www2.hm.com/fr_fr/index.html"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="zara"
              lien="https://www.zara.com/fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="boss"
              lien="https://www.hugoboss.com/fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="primark"
              lien="https://www.primark.com/fr-fr"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="sephora"
              lien="https://www.sephora.fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="hm"
            ...
            <CardMarque
              image="/images/marque/1.png"
              nom="nike"
              lien="https://www.nike.com/fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="vans"
              lien="https://www.vans.fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="bershka"
              lien="https://www.bershka.com/fr/"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="celio"
              lien="https://www.celio.com/fr-fr"
            />
            <CardMarque
              image="/images/marque/1.png"
              nom="fils"
