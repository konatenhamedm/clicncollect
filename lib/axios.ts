...
export const BASE_URL = "http://api.clicncollect.com/api";
export const BASE_URL_AUTH = "http://api.clicncollect.com/api";
export const BASE_SITE = "https://admin.clicncollect.com/uploads/";
const BASE_URL1 = "http://api.clicncollect.com/api"; 
